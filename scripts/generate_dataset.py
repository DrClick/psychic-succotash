...
from classical_composer.data import extract_data, create_file_dataframe
...
3) Create a dataframe containing information about MIDI files, including file paths, composers, and file indices.
...
#2) Create a dataframe containing information about MIDI files, including file paths, composers, and file indices.
